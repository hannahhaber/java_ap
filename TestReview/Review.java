...
public class Review {
  ...
  public static double totalSentiment(String fileName)
  {
   ...
   for (int i = 0; i<reviewFile.length(); i++){
     if (reviewFile.substring(i,i+1).equals(" ")){
        singleWord = reviewFile.substring(0,i);
        singleWord = removePunctuation(reviewFile);
        System.out.println(singleWord.substring(0,i));
     }
   }
  return 0; 
